...
model2 = load_model('first_model_simplify_v2.h5')
...
while True:
    ...
    prediction2 = model2.predict_classes(sA)
    print("Right Paddle" + str(prediction))
    print("Left Paddle" + str(prediction2))
    print("")
